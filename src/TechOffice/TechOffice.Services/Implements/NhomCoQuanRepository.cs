...
namespace AnThinhPhat.Services.Implements
{
    ...
    {
        public NhomCoQuanRepository(ILogService logService) : base(logService)
        {
        }
        ...
        public SaveResult Add(NhomCoQuanResult entity)
        {
            return ExecuteDbWithHandle(_logService, () =>
            {
                ...
                {
                    var add = context.NhomCoQuans.Create();
        ...
        public async Task<SaveResult> AddAsync(NhomCoQuanResult entity)
        {
        ...
        public async Task<SaveResult> AddRangeAsync(IEnumerable<NhomCoQuanResult> entities)
        {
            return await ExecuteDbWithHandleAsync(_logService, async () =>
            {
                using (var context = new TechOfficeEntities())
        ...
        public SaveResult Delete(NhomCoQuanResult entity)
        {
            return ExecuteDbWithHandle(_logService, () =>
            {
                using (var context = new TechOfficeEntities())
                {
                    var cv = context.NhomCoQuans.Single(x => x.Id == entity.Id && x.IsDeleted == false);
        ...
        public async Task<SaveResult> DeleteAsync(NhomCoQuanResult entity)
        {
            return await ExecuteDbWithHandleAsync(_logService, async () =>
            {
                using (var context = new TechOfficeEntities())
        ...
        public SaveResult DeleteBy(int id)
        {
            return ExecuteDbWithHandle(_logService, () =>
            {
                using (var context = new TechOfficeEntities())
                {
                    var cv = context.NhomCoQuans.Single(x => x.Id == id && x.IsDeleted == false);
        ...
        public async Task<IEnumerable<NhomCoQuanResult>> GetAllAsync()
        {
            return await ExecuteDbWithHandleAsync(_logService, async () =>
            {
                using (var context = new TechOfficeEntities())
                {
                    return await (from item in context.NhomCoQuans
                                  where item.IsDeleted == false
        ...
        public IEnumerable<NhomCoQuanResult> GetAllWithChildren()
        {
            return ExecuteDbWithHandle(_logService, () =>
            {
                using (var context = new TechOfficeEntities())
                {
                    return (from item in context.NhomCoQuans.Include(x => x.CoQuans)
                            where item.IsDeleted == false
                            select item)
                        .MakeQueryToDatabase()
                        .Select(x => x.ToDataResult())
        ...
        public async Task<NhomCoQuanResult> SingleAsync(int id)
        {
            return await ExecuteDbWithHandleAsync(_logService, async () =>
            {
                using (var context = new TechOfficeEntities())
        ...
        public async Task<SaveResult> UpdateAsync(NhomCoQuanResult entity)
        {
            return await ExecuteDbWithHandleAsync(_logService, async () =>
            {
                using (var context = new TechOfficeEntities())
