...
namespace AnThinhPhat.Entities
{
    ...
    public partial class TechOfficeEntities : DbContext
    {
        ...
        public virtual ObjectResult<Summaries_Result> Summaries(Nullable<int> noiVuId, Nullable<System.DateTime> from, Nullable<System.DateTime> to)
        {
            var noiVuIdParameter = noiVuId.HasValue ?
                new ObjectParameter("NoiVuId", noiVuId) :
                new ObjectParameter("NoiVuId", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Summaries_Result>("Summaries", noiVuIdParameter, fromParameter, toParameter);
        }
    }
}
